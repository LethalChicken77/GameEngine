...
namespace core
{
    ...
    {
        public:
            static inline float getRandom01(uint32_t seed)
            {
                rng.seed(seed);
            ...
            static inline int getRandomInt(int min, int max, uint32_t seed)
            {
                rng.seed(seed);
            ...
            static inline float getRandomFloat(float min, float max, uint32_t seed)
            {
                rng.seed(seed);
            ...
            // 2D Seed Function
            static inline uint32_t SeedFrom2D(int x, int y, int baseSeed = 0)
            {
            ...
            // 3D Seed Function
            static inline uint32_t SeedFrom3D(int x, int y, int z, int baseSeed = 0)
            {
            ...
            // 4D Seed Function
            static inline uint32_t SeedFrom4D(int x, int y, int z, int w, int baseSeed = 0)
            {
            ...
            // 2D Seed Function
            static inline uint32_t SeedFrom2D(float x, float y, int baseSeed = 0)
            {
                return SeedFrom2D(std::bit_cast<int>(x), std::bit_cast<int>(y), baseSeed);
            }

            // 3D Seed Function
            static inline uint32_t SeedFrom3D(float x, float y, float z, int baseSeed = 0)
            {
                return SeedFrom3D(std::bit_cast<int>(x), std::bit_cast<int>(y), std::bit_cast<int>(z), baseSeed);
            }

            // 4D Seed Function
            static inline uint32_t SeedFrom4D(float x, float y, float z, float w, int baseSeed = 0)
            {
